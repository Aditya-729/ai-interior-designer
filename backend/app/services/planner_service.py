"""
Command planner service - converts user requests into structured edit instructions.
"""
...
class PlannerService:
                ...
                validated.append(
                    {
                        ...
                        "style": edit.get("parameters", {}).get("style"),
                        "color": edit.get("parameters", {}).get("color"),
                        "material": edit.get("parameters", {}).get("material"),
                        "strength": 0.7,
    ...
    def _apply_preferences(
        ...
        for edit in edits:
            if not edit.get("color") and preferred_colors:
                edit["color"] = preferred_colors[0]
            if not edit.get("material") and preferred_materials:
                edit["material"] = preferred_materials[0]
